...
public class Image {
     ...
     * @param filename to construct the image from.
    ...
    /**
     * Constructs an image with a given Color array.
     * @param pixelArray of the colors.
     ...
     * @return the given pixel Color value.
     */
